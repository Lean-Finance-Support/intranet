...
<head>
  ...
  <title>Nuevo Dashboard Lean Finance — ${escapeHtml(ctx.companyName)}</title>
</head>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;">
        ...
        <tr><td style="background-color:#ffffff;border-radius:12px;padding:40px 40px 32px;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
          ...
          <div style="margin:32px 0 24px;padding:24px 24px 20px;background:linear-gradient(135deg,#0f2444 0%,#16335a 100%);border-radius:12px;color:#ffffff;">
            ...
            <p style="margin:0 0 20px;font-size:14px;color:#cfd8e3;line-height:1.6;">Para activar el volcado y empezar a recibir el Dashboard, necesitamos vuestra aprobación firmando el nuevo <strong style="color:#ffffff;">contrato de tratamiento de datos</strong>. Lo encontraréis disponible en vuestro portal, dentro del apartado <em>${escapeHtml(ctx.apartadoName)}</em> del bloque Contratos.</p>
          ...
          <p style="margin:24px 0 0;font-size:14px;color:#4b5563;line-height:1.6;">Cualquier duda, escríbenos respondiendo a este correo.</p>
          <p style="margin:16px 0 0;font-size:14px;color:#4b5563;line-height:1.6;">Un saludo,<br/><strong style="color:#0f2444;">${escapeHtml(ctx.senderName)}</strong></p>
...
Para activar el volcado y empezar a recibir el Dashboard, necesitamos que firméis el nuevo contrato de tratamiento de datos en vuestro portal, dentro del apartado "${ctx.apartadoName}" del bloque Contratos.

Acceder al portal: ${ctx.apartadoUrl}

Cualquier duda, escríbenos respondiendo a este correo.
