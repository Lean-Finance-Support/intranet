...
export default function NotifyWelcomeButton({ companyId, alreadySent, sentAt, onSent }: NotifyWelcomeButtonProps) {
    ...
    return (
      <div className="flex items-center gap-2 text-xs text-text-muted">
        ...
        <span>
          ...
          {sentAt && (
            <> el {new Date(sentAt).toLocaleDateString("es-ES", {
              day: "numeric",
              month: "short",
              year: "numeric",
            })}</>
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        <MailIcon />
        {sending ? "Enviando..." : confirming ? "Confirmar envío" : "Notificar al cliente"}
      </button>
