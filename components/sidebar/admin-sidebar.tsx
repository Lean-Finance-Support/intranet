...
// ---- Main Component ----
export default function AdminSidebar({ profile, hasTaxModels, loginPath, linkPrefix, unreadCount }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden w-10 h-10 rounded-lg bg-brand-navy/90 backdrop-blur border border-white/10 shadow-lg flex items-center justify-center text-white"
      >
        ...
        <div className="fixed inset-0 z-40 flex lg:hidden">
          ...
          <div className="relative w-64 h-full flex flex-col bg-brand-navy border-r border-white/10 animate-slide-in-right">
            <div className="flex items-center justify-between px-3 py-3 border-b border-white/10">
              <span className="text-sm font-medium text-white/70">Menú</span>
              <button onClick={() => setMobileOpen(false)} className="w-8 h-8 rounded-lg hover:bg-white/10 flex items-center justify-center text-white/60 hover:text-white">
